...
class FadeDisplay(IDisplay):
    ...
    def num_total_groups(self) -> int:
        return self.num_visible_groups
    ...
    def __init__(self, pixels: neopixel.NeoPixel, settings: DisplaySettings,
                 cmap: colormap.ColorMap | None = None,
                 smooth_factor: float | None = None, smooth_samples=2):
    ...
    def show(self, power_spectrum: np.array):
        ...
        for i_col in range(0, len(self._group_power)):
            i = i_col
            ...
            i_range, norm_value = map_normalized_power_to_range(norm_value, range_cutoffs=self._colormap.range_cutoffs)
